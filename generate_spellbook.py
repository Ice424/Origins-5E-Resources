...
def generate_spellbook():
    ...
    passive_power_template = 'execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={id}] run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:stick", "components": {{"custom_model_data": {predicate}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{description}\\"}}"],custom_name:"{{\\"color\\":\\"{color}\\",\\"italic\\":false,\\"text\\":\\"{name}\\"}}", "minecraft:custom_data": {{ui_item: {{empty: 1b}}}}}}}}'

    equipped_power_template = """execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={id}] run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:stick", "components": {{"custom_model_data": {predicate}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{description}\\"}}"],custom_name:"{{\\"color\\":\\"{color}\\",\\"italic\\":false,\\"text\\":\\"{name}\\"}}", "minecraft:custom_data": {{ui_item:{{cmd:"function ui:menu/{type}/slot_select/open {{predicate:{predicate}}}"}}}}}}}}"""

    greyscale_powers_template = 'execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag=!{id}] run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:iron_nugget", "components": {{"custom_model_data": {predicate}, custom_name:"{{\\"color\\":\\"dark_gray\\",\\"italic\\":false, \\"text\\":\\"{name}\\"}}", "minecraft:custom_data": {{ui_item: {{empty: 1b}}}}}}}}'

    equipped_display_template = 'execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if score @s {key} matches {predicate} run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:stick", "components": {{"custom_model_data": {predicate}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{description}\\"}}"],custom_name:"{{\\"color\\":\\"{color}\\",\\"italic\\":false,\\"text\\":\\"{name}\\"}}", "minecraft:custom_data": {{ui_item:{{empty: 1b}}}}}}}}'
            ...
            for power in powers["class"][classes][types]:
                ...
                if power["predicate"] <= 1000:
                    if power["key_activated"] is True:
                        ...
                        out.append(passive_power_template.format(predicate=power["predicate"], id=power["id"], slot = low_slot, type=types,     description=power["description"],   name=power["name"], color=color).replace(f"execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={power["id"]}] run ", ""))
                        low_slot += 1
                    else:
    ...
    for power in powers["high"]:
        if power["predicate"] <= 1000:
            if power["id"] != "grow" and power["id"] != "shrink":
                ...
                if power["id"] == "grow": 
                    out.append(f"""execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={power["id"]}] if score @s size matches 1 run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:acacia_boat", "components": {{"enchantment_glint_override":true, "custom_model_data": {power["predicate"]}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{power["description"]} click to toggle\\"}}"],custom_name:"{{\\"color\\":\\"{"dark_purple"}\\",\\"italic\\":false,\\"text\\":\\"{power["name"]}\\"}}", "minecraft:custom_data": {{ui_item:{{cmd:"execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run function ui:menu/main/size_toggle {{predicate:{power["predicate"]}}}"}}}}}}}}""")
                    out.append(f"""execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={power["id"]}] unless score @s size matches 1 run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:stick", "components": {{"enchantment_glint_override":false, "custom_model_data": {power["predicate"]}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{power["description"]} click to toggle\\"}}"],custom_name:"{{\\"color\\":\\"{"dark_purple"}\\",\\"italic\\":false,\\"text\\":\\"{power["name"]}\\"}}", "minecraft:custom_data": {{ui_item:{{cmd:"execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run function ui:menu/main/size_toggle {{predicate:{power["predicate"]}}}"}}}}}}}}""")
                else:
                    out.append(f"""execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={power["id"]}] if score @s size matches 2 run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:acacia_boat", "components": {{"enchantment_glint_override":true, "custom_model_data": {power["predicate"]}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{power["description"]} click to toggle\\"}}"],custom_name:"{{\\"color\\":\\"{"dark_purple"}\\",\\"italic\\":false,\\"text\\":\\"{power["name"]}\\"}}", "minecraft:custom_data": {{ui_item:{{cmd:"execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run function ui:menu/main/size_toggle {{predicate:{power["predicate"]}}}"}}}}}}}}""")
                    out.append(f"""execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run execute if entity @s[tag={power["id"]}] unless score @s size matches 2 run data modify storage ui mask insert 0 value {{Slot: {slot}b, id:"minecraft:stick", "components": {{"enchantment_glint_override":false, "custom_model_data": {power["predicate"]}, lore:["{{\\"color\\":\\"gray\\",\\"italic\\":false,\\"text\\":\\"{power["description"]} click to toggle\\"}}"],custom_name:"{{\\"color\\":\\"{"dark_purple"}\\",\\"italic\\":false,\\"text\\":\\"{power["name"]}\\"}}", "minecraft:custom_data": {{ui_item:{{cmd:"execute as @a[scores={{ui.id=1..}}] if score @s ui.id = @s ui.id run function ui:menu/main/size_toggle {{predicate:{power["predicate"]}}}"}}}}}}}}""")
